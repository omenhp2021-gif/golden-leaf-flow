    ...
    <footer className="bg-gradient-to-br from-tea-brown via-tea-earth to-tea-brown text-primary-foreground">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="relative">
                <Leaf className="w-8 h-8 text-tea-green-light" />
              ...
              <div className="flex flex-col leading-tight">
                ...
                <span className="text-xs text-primary-foreground/70 tracking-wider">TEA GARDEN</span>
              </div>
            </div>
            <p className="text-sm text-primary-foreground/80 leading-relaxed">
              From Garden to Cup, Naturally. Premium orthodox teas from the heart of the Himalayas.
            </p>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-primary-foreground/60">
          <p>&copy; {currentYear} Kanchan Tea Garden. All rights reserved.</p>
